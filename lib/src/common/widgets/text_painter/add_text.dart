                ...
                children: [
                  AvailableOptions(
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomIconButton(
                          icon: (_textDirectionValue == TextDirectionValue.left
                          ...
                          onTap: () => setState(() {
                            if (_textDirectionValue ==
                              ...
                              _textDirectionValue = TextDirectionValue.center;
                                ...
                                TextDirectionValue.center) {
                              _textDirectionValue = TextDirectionValue.right;
                            } else if (_textDirectionValue ==
                        ...
                        CustomIconButton(
                          ...
                          onTap: () => setState(() {
                            ...
                            } else if (_boxType == BoxType.transparent) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: index == 1 && selectedColorIndex != 1
                                    ? 0.5
                                    : 1,
                                color: selectedColorIndex == index || index == 1
                                    ? CustomColors.secondaryColor
